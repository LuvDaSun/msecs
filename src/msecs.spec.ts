...
test("date time math", () => {
    ...
    assert.equal(
        ...
        new Date("2023-04-22T08:14:25Z").toISOString(),
    )

    const inTwoWeeks = now + 2 * week;
    assert.equal(
        new Date(inTwoWeeks).toISOString(),
        new Date("2023-05-05T08:14:25Z").toISOString(),
    )
    ...
    */
    ...
    assert.equal(
        ...
        new Date("2023-04-22T00:00:00Z").toISOString(),
    )
